...
export default class {
  ...
  handleShowTickets(e, bills, index) {
    ...
    arrow.classList.toggle("open-list")
    ...
    if(arrow.classList.contains('open-list')){
      ...
      billsContainer.innerHTML = cards(uiFilteredBills)
      /*Pour chaque ticket on ajoute un listener pour l'édition */
      uiFilteredBills.forEach( bill => {
