    ...
    <div class='layout'>
      ...
      <div class='dashboard-content'>
        <div class='bills-feed'>
          ...
          <div class='status-bills-container' id='status-bills-container1' data-testid= "bills-container-1">
          </div>
            ...
            <div class='status-bills-container' id='status-bills-container2' data-testid= "bills-container-2">
            </div>
